...
export const DEFAULT_VIRTUAL_INSTANCE_NAME = 'www.able.com';
export const DEFAULT_VIRTUAL_INSTANCE_URL = `http://${DEFAULT_VIRTUAL_INSTANCE_NAME}:8080`;
...
export async function enableTokenBasedSSO(systemSettingsPage) {
    ...
    await tokenBasedSSOPage.getByRole('option', {name: 'Request Header'}).click();
